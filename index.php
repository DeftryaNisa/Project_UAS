...
?>
   ...
   <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index.html">RS DEFTRYANISA<span>.</span></a></h1>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      <h1>Welcome to <span>RS DEFTRYANISA</spa>
      </h1>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              ...
              <p class="description">RUmah Sakit DEFTRYANISA memiliki lebih dari 500 dokter umum, 2.200 spesialis, 
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 content d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="100">
            ...
            Temui layanan pemeriksaan kami Rumah Sakit DEFTRYANISA terdekat.</p>
            <ul>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6 footer-contact">
        ...
        <p>
          Universitas Gajayana Malang <br>
          Jl. Mertojoyo Malang<br>
          Indonesia <br><br>
...
<div class="container py-4">
  ...
  <div class="credits">
    ...
    Designed by <a href="">@deftryanisa</a>
  </div>
</div>
</footer><!-- End Footer -->
